    ...
    return (
      <div>
        <form onSubmit={this.handleSubmit.bind(this)}>
          ...
          <div>Pepperoni <input id="pepp" type="checkbox"/> 
          </div>
          
          <div>Gluten Free <input id="g-free" type="checkbox"/>
          </div>

          <div>  Quantity <input type="number" id="quantity" min="1" max="5" />       </div>
          <div>Additional Instructions</div>
            <textarea id="add-instr" name="paragraph_text" cols="50" row="3" placeholder="Stuffed Crust, No Cheese, No Sauce, Add Mushrooms" ></textarea>
          <div></div>
